...
def requirements(rows):
    ...
    L = [f"{TITLE.upper()} - required Steam Workshop mods", "",
         ...
         "by Type=, SquadronReference=, VariantReference= or a loadout's store.",
         "",
         ...
         "",
         "Subscribe in the Steam Workshop, then check the Mod Manager list",
         "against LOAD-ORDER.txt in this folder.", "",
