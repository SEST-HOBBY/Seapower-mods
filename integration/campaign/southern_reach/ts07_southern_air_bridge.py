...
MISSION = dict(
    ...
    intent=("RELIEF 21 is an Airbus with the New Zealand relief "
            ...
            "Williamtown's fighters above. The airliners on the same route "
            "are not to be shot at by anybody, and if the carrier's pilots "
            "cannot tell an Airbus from an Airbus, that is a thing we make "
            "sure of."),
    ...
    brief=(
        ...
        "with a J-15D behind them is routed onto the charter's track and "
