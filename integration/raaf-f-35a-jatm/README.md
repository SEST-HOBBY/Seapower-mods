...
LRAAM the US Navy revealed on 22 August 2026 — two-stage, SM-6-bodied, 290 nm here against
the Navy's stated "in excess of 250", with a passive anti-emitter mode. Keep **US Naval
Aviation** enabled: no AIM-424 mesh exists, so the missile renders on its AGM-88G model.
