...
| RE-power: the resupply mod | unknown | ship | Naval resupply mechanics: 23 vessels and 4 land units. SEST_Replenishment overrides 9 of the 23 at tier 0 (Sacramento, Kilauea, T2, Boris Chilikin, Kazbek, Don, Delvar, Sealift Pacific, Algol): it forks vanilla for those hulls and adds only a tuned supply block, so RE-power's other edits to them do not load. Its 14 other ship suppliers and its 4 land units are shipped by no other mod or SEST pack, so they keep working below the SEST packs. |
