...
147 Workshop mods catalogued — 142 in the local inventory, 5 historical entries kept for reference, grouped by faction. Generated from `data/mod-catalog.json` by `tools/generate_catalog.py` — edit the JSON, not this file.
...
| [DEPRECATED] Boeing F/A-18E/F Super Hornet — historical / unsubscribed | MyGo!!!!!鼓手椎名立希 | fixed-wing | UNSUBSCRIBED 2026-09-20 (gone from the export), as the setup runbook's Phase 2 recommended. Murder Hornet and U.S. Navy 2027 cover the Super Hornet. Previously: Integrated into Modern US Navy. Unsubscribe candidate — BUT F/A-18 Murder Hornet targets the E/F; verify compatibility before removing. |
| [DEPRECATED] Lockheed Martin F-35C Lighting II — historical / unsubscribed | MyGo!!!!!鼓手椎名立希 | fixed-wing | UNSUBSCRIBED 2026-09-20 (gone from the export). MEASURED CONSEQUENCE: it was the winning provider of usaf_aim-120c7, the RAAF F-35A's primary BVR round, and the fallback is now 3514484654's own copy - AntiCountermeasuresBonus and AntiJammerBonus both drop 0.6 -> 0.1, while MaxVelocity rises 1600 -> 2666 kt and MaxLaunchRange 65 -> 70 nm. Every mission F-35A now flies a faster, longer-legged AMRAAM with almost no ECCM. Its other flagged dependency is fine: usn_gbu-53_mat.ini is still shipped by 3737267013. Previously: Integrated into Modern US Navy. Unsubscribe candidate — BUT F-35C Alt. Loadouts was written against THIS mod; verify compatibility before removing. |
...
| YF-23 Black Widow II | unknown | fixed-wing | What-if production YF-23. Ships its own missions/ folder as well as the airframe. Zero whole-file collisions. Upstream now carries its own AIM-424 fit (AirToAirIntercept: 2x yf23_aim424_internal on its own mesh), so no SEST YF-23 MALICE pack is needed; the one built for the older six-airframe layout targeted yf23_f23a_block40_2025.ini, which upstream has removed. |
...
| U.S. Navy 2027 Capabilities mod | Prof_CH4OS | patch | Compilation of edits to many US Navy mods to reflect near-real capabilities. Highly load-order sensitive; overlaps with Dingtools Weapon Pack and Murder Hornet on modern US weapons. Recommendation (not author instruction): keep above the mods it modifies; if its edits touch weapons also defined by Dingtools Weapon Pack, it must sit above that pack too — test. **Fragile by construction:** 28 of its hulls (every Arleigh Burke and the 2027 Nimitz) are `#!alias` patches over Modern US Navy hulls, so a rename there breaks them until its author catches up, and the game then dies at startup with KeyNotFoundException 'AirGroup' rather than warning (Modern US Navy v567 renamed the Flight III usn_ddg_burke_f3 to usn_ddg_burke_f3_125 on 18 Sep 2026 while flt3_2027 still aliased the old name). As of the 24 Sep 2026 export all 28 bases resolve, flt3_2027 -> usn_ddg_burke_f3_125 included, so missions keep the 2027 hulls and their loadouts. Run tools/check_alias_bases.py after every mirrored export; on a MISSING BASE, disable this mod until it is updated or override the one file. **Requires:** the US Navy mods it edits (compilation of edits to multiple Workshop mods) |
...
| MH-60R Seahawk | 2154545636 | rotary | Standalone MH-60R. FOUR sources of MH-60-family helicopters in this list — duplicate/ID-conflict watch. **Load order:** Sits directly above US Naval Aviation (collection audit, 2026-09). The squadron table that rationale was about is now SEST Collection Fixes' own: U.S. Navy 2027's current usn_mh-60r draws US Naval Aviation's sh60 model (Modex/Emblem submodels), so the composed table is US Naval Aviation's plus 816 Squadron RAN. Still load-bearing - keep subscribed: ADO Nimitz 2000s' carrier draws its deck Seahawks from this mod's assets/models/aircraft/usn_sh-60b/ folder. **Overlaps:** us-naval-aviation (MH-60R); modern-us-navy (MH-60); ado-nimitz-2000s (adds MH-60R) |
| MV-22B Osprey Tiltrotor / JGSDF V-22B | unknown (Workshop 3806466625) | rotary | Unarmed tiltrotor, two units: mv22b_osprey (USMC, VMM-263 / VMM-162) and jgsdf_mv22b_osprey (JGSDF 107th/108th). UnitType=VTOL, CarrierCapable=True, Role=Transport,SAR; loadouts Empty, Transport (32 seats, also used for SAR and medevac) and Ferry; 275 kt, 2,200 km total range. Ships systems/sensors.ini with four uniquely named entries (MV22_SearchRadar, MV22_FLIR, MV22_RWR, MV22_DECM), so it adds to the sensor registry and collides with nothing. Southern Watch flies it as US Marine rotational lift out of Darwin: one of the two rescue lifters in Rig Seventeen, off HMAS Canberra, and the airhead lift in The Long Perimeter. Never sold - it is a US allocation. Catalogued 24 Sep 2026 from the export; not yet seen in the game. **Requires:** anchor-chain (stated: 'Requires Anchor Chain (3380210757)'; the flight mechanics are OspreyMechanics.dll) |
...
| Modern US Navy | Mitchell600 | ship | Arleigh Burke, Wasp, Freedom LCS, Zumwalt and more; now also includes the F-35C, F/A-18E/F and MH-60 (absorbed the MyGo aircraft mods). Required by Ford-class CVN. **Renames hulls often (Sep 2026):** the Flight IIA became per-ship files (usn_ddg_burke_f2a_085, _085_late, _088_laser, _089 ...) on 16-17 Sep and the Flight III became usn_ddg_burke_f3_125 (v567, 18 Sep). U.S. Navy 2027 aliases into these names and breaks whenever one moves; tools/check_alias_bases.py finds it. The old names can linger in mods-source until an export with the deletion mirror removes them. **Overlaps:** us-naval-aviation (SH-60/MH-60 family); mh-60r-2154545636; ado-nimitz-2000s (MH-60R); f-35c-alt-loadouts and murder-hornet (patch targets after the MyGo integration) |
...
| RQ-180 White Bat Airframe | unknown | uav | High-altitude stealth ISR UAV (usaf_rq-180). Zero whole-file collisions. |
...
| MiG-31 Foxhound | unknown | fixed-wing | MiG-31, -31BM and -31K (Kinzhal carrier). Zero whole-file collisions. |
...
| J-16 Multirole Fighter | unknown | fixed-wing | Second J-16 in the collection. Verified additive: no shared files with 3506979898, so this is a duplicate platform rather than a conflict - two J-16 entries will appear in the editor. **Overlaps:** j-16a (3506979898) - same platform, DIFFERENT unit ids (plaaf_j16 vs plaf_j16a), so both coexist |
...
| J-36 Tailless Fighter | unknown | fixed-wing | Sixth-generation tailless demonstrator (plaaf_j36). Zero whole-file collisions. |
...
| Shenyang J-11 | misaka | fixed-wing | PLA heavy twin-engine fighter based on Su-27SK. **Load order:** Moved above Type 003/004 CVN, below CV-18 Fujian (collection audit): its PL-12/PL-8B/R-27 family are the live-schema (ApplyKinematics/AntiCountermeasuresBonus) versions its own mission-fielded J-11s were authored against; also repairs the corrupted ApplyKinematics line in Apex Predators' wp_aa-10a and the broken 250-III material path. **Overlaps:** j-11bs; flanker-family; su-27ubk (Flanker airframes) |
...
| Type 003 Aircraft Carrier - PLANS Fujian CV-18 | 八一of军魂 | ship | Fujian with multiple selectable loadouts. One of THREE Fujian carriers in this list — same author as Modern PLAN Systems; likely pairs with it. **Load order:** Moved above Type 003/004 CVN (collection audit): its PL-10 (AntiCountermeasuresBonus 0.95 vs 0.05, 12 nm seeker), PL-15, YJ-91 and KD-88 are the modern-schema versions; the mission's 28 fielded PL-10s were flying the flare-bait copy. **Overlaps:** type-003-004-maneuverwarfare (Fujian); chinese-navy-plan (Fujian) |
| Type 003 Fujian / Type 004 CVN Aircraft Carriers | ManeuverWarfare | ship | Kitbash Fujian plus speculative Type 004. One of THREE Fujian carriers in this list — pick a primary. **Requires:** sealifter; anchor-chain **Load order:** Moved above Chinese Navy (PLAN) (collection audit): its purpose-built CATOBAR Fujian (85 aircraft, Type 346B, HQ-10) was being overridden by PLAN's Orel-hull reskin. Zero other files change hands - the two mods contest only the Fujian pair. **Overlaps:** chinese-navy-plan (Fujian); fujian-cv-18 (Fujian) |
| PLAN Submarines | ManeuverWarfare | submarine | Type 039G Song, 039A/B/C Yuan, Type 093/093A Shang kitbashes. |
| PLA & PLAN & PLAAF AEP | unknown | weapons | Anchor Chain expansion pack of PLA/PLAN/PLAAF ordnance (DF-15/21/21D/26, YJ-18/20, HHQ-9C, HQ-19, AKF-98 and more). Ships a params/ folder and debug.ini alongside assets. Zero whole-file collisions. Placed with the other Anchorchain expansion pack, directly below the loader. **Requires:** anchor-chain (its own description: 'Anchorchain Expansion Pack') |
...
| Mod | Author | Type | Notes |
|---|---|---|---|
| Euromod-South Korea Navy | unknown (Workshop 3789208859) | ship | ROK Navy addon to Euromod. Sejong the Great (KDX-III, 3 hulls), Chungmugong Yi Sun-sin (KDX-II), Gwanggaeto (KDX-I), Incheon and Daegu FFG, Ulsan FF, Dokdo LPH, Pohang PCC, Yoon Youngha PKG, Chamsuri PKM/PKMR; Lynx Mk99/Mk99A and UH-60P; K2 MBT. Every weapon it hangs resolves: its own Haeseong, K-SAAM, Hyunmoo, Bilyong and K-745 files, the rest through Euromod main (RIM-66M-5, RIM-116, RUM-139, Mk46) and vanilla. The DDG and FFG decks list rok_mk99_a. No TaskForceCost in the hull files - the campaign uses the ships as a theatre contribution, not a purchase. Verified 23 Sep 2026 from the export; not yet seen in the game. **Requires:** euromod-main |
...
| [DEPRECATED] Anzac Class Frigate ⚠️ **DEPRECATED** | unknown (model by Jason Simpson, Simpson's Virtual Slipway, used with permission) | ship | KEEP - SEST_RAN_Fleet is built ON it. REBASED 2026-09-20: the pack used to clone Euromod's Type 23 MLU as an Anzac stand-in, which masked this mod's hull because both ship vessels/ran_ffh_anzac.ini and SEST wins at tier 0. The pack now PATCHES this file instead, so the real ASMD hull is what you see - CEAFAR/CEAMOUNT arrays, Ceros 200 directors, Spherion sonar, and this mod's own FFH-150..157 hull-number and emblem textures. SEST no longer ships ran_ffh_anzac_variants.ini or Anzac vessel names at all; this mod's own are better and now win. Four deltas SEST applies: NSM standardised to knm_nsm_1a (what Hobart and four other fielded hulls fire), the Mk41 magazine repaired (a duplicated Ammunition1_Count silently cut ESSM from 32 to 16 and left an uncounted usn_rim-66h that NumberOfAmmunitionTypes=1 never enabled), its Mk41 loaded with Euromod's usn_rim-162h ESSM Block II instead of its own 'RIM-162 ESSM' (an unrevised RIM-7F template - no kinematic model, MinAttackAltitude=26 ft so every sea-skimmer is out of band; reported in game flying at a metre above the sea),  and AircraftSupported added so the deck operates the MH-60R. Its own RGM-184A and RIM-162 ESSM remain defined and unused. ApproximateVersion=0.4.0, well behind the 0.8.x collection. **Overlaps:** SEST_RAN_Fleet (patches this mod's vessels/ran_ffh_anzac.ini; SEST must stay ABOVE it, which tier 0 guarantees) |
...
| RE-power: the resupply mod | unknown | ship | Naval resupply mechanics: 23 vessels and 4 land units. SEST_Replenishment overrides 9 of the 23 at tier 0 (Sacramento, Kilauea, T2, Boris Chilikin, Kazbek, Don, Delvar, Sealift Pacific, Algol): it forks vanilla for those hulls and adds only a tuned supply block (and, on the Don, two launcher reload flags), so RE-power's other edits to them do not load. Its 14 other ship suppliers and its 4 land units are shipped by no other mod or SEST pack, so they keep working below the SEST packs. |
...
| Automatic SAR | unknown (Workshop 3774105087) | framework | Code mod - its export is AutomaticSAR.deps.json (the DLL itself is a binary the export skips) plus a language file per locale; no game data. Adds 'Start automatic SAR' to a unit's right-click menu: helicopters work distress beacons (nearest downed pilot or nearest beacon first), ships and submarines visit sunk vessels with beacons nearby, and a unit returns to base or loiters when done. Southern Watch uses it through the campaign's own survivor reward (CSARPointModifier): survivors a helicopter or ship picks up are counted in the debrief and paid as requisition points. Position not order-sensitive; sits in the Anchor Chain code-mod tier. Catalogued 24 Sep 2026 from the export; not yet seen in the game. **Requires:** anchor-chain (inferred: it ships AutomaticSAR.dll, and every DLL mod in this collection loads through the chainloader) |
