...
Generated from `data/mod-catalog.json` by `tools/generate_load_order.py` — 138 active subscriptions plus the SEST Integration Pack (18 packs consolidated). Top of the Mod Manager = highest priority: the higher-listed mod wins file conflicts.
