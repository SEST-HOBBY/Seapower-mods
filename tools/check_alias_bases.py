...
Modern US Navy v567 (Flight III renamed from usn_ddg_burke_f3 to
usn_ddg_burke_f3_125, 18 Sep 2026) did to U.S. Navy 2027's
usn_ddg_arleigh_flt3_2027, and the game's own log names the symptom, not the
file.
...
export passes while the game crashes - export first, then check. The same
goes for a file the author deleted: until export-mod-configs.ps1 has mirrored
the deletion, mods-source/ still holds it and a base that is gone in game
still resolves here.
"""
import re
import sys
