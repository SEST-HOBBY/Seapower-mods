...
SEST A-10C+ was first built with exactly this defect. It referenced
SystemName=Litening intending the A-10C mod's pod (2.2/4.0 multipliers, night
vision 1.0) and got Euromod JMSDF's instead (3.0/3.4, night vision 0.5),
because several mods define that name and the A-10C's copy ranks below them.
Since the 2026-09-21 export the winner is the Italian Navy Mod's pod, with the
same figures. The upgrade was worse after dark than the sensor it replaced,
and the pack's own README quoted figures the aircraft never had. Fixed by
shipping SEST_A10C_FLIR under a name nothing else uses.
