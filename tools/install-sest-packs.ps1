...
.DESCRIPTION
    ...
    Old "<name> backup-<stamp>.ini" files are no longer deployed; -PurgeBackups
    removes the ones already in the game folder.
...
.EXAMPLE
    ...
    # Also clear the old backup missions out of the game's mission list:
